...
export function deleteWorkflow(workflowId: string, signal?: AbortSignal) {
  return http<void>(apiUrl(`/workflows/${encodeURIComponent(workflowId)}`), {
    method: "DELETE",
    parseAs: "void",
    signal,
  });
...
export function getWorkflowVersion(
  ...
  return apiClient<WorkflowVersionDetail>(
    apiUrl(
      `/workflows/${encodeURIComponent(workflowId)}/versions/${versionNumber}`,
    ),
    { method: "GET" },
    { signal },
  );
...
export function getWorkflowDiagramData(
  workflowId: string,
  signal?: AbortSignal,
) {
...
export function getWorkflowDecisionLog(
  workflowId: string,
  signal?: AbortSignal,
) {
...
export function getWorkflowAuditLog(
  ...
  return apiClient<WorkflowAuditLogResponse>(
    apiUrl(
      `/workflows/${encodeURIComponent(workflowId)}/audit-log`,
...
export function exportWorkflow(
  ...
  return http<Blob>(
    apiUrl(`/workflows/${encodeURIComponent(workflowId)}/export/${type}`),
    {
      method: "POST",
      parseAs: "blob",
      signal,
